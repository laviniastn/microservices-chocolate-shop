...
public class UserServiceApplication {
    ...
    CommandLineRunner run(UserService userService, RoleService roleService) {
        return args -> {
            ...
            userService.create(new RegistrationDTO("customer@gmail.com" , "1234"), roles1);
            userService.create(new RegistrationDTO("seller@gmail.com", "1234"), roles2);
            userService.create(new RegistrationDTO("admin@gmail.com", "1234"), roles3);
